...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        1) Type a valid <b>PO Number</b> into the Text Box in the upper left hand corner of the <b>PO Lookup</b> page  and click <b>Search</b>.<br />
    ...
    <p>
        1) Type exactly what you want on each line into the <b>Text Area</b> on the <b>Custom Label</b> page.<br />
        2) Select the <b>Label Type</b> and number of <b>Copies</b>.<br />
        3) Select the <b>Printer</b> you would like to use.<br />
        4) Click <b>Print</b>.<br />
    </p>
    ...
    <table>
        ...
        <tr>
            <td style="padding: 0px 30px 30px 0px; vertical-align: top;"><img src="Resources/Images/SmallRecvLabel_small.jpg" alt="Small Receiving Label"/></td>
            <td style="padding: 0px 30px 30px 30px; vertical-align: top;"><img src="Resources/Images/LargeRecvLabel_small.jpg" alt="Small Receiving Label"/></td>
        </tr>
    </table>
</asp:Content>
